...
def main():
	...
	parser.add_argument('mot',nargs="?", help="The phrase you want to look up", type=str)
...
#	header = "{'User-Agent': 'Mozilla/5.0 (X11; Ubuntu; Linux x86_64; rv:60.0) Gecko/20100101 Firefox/60.0'}"
	...
	for i in range(nb_pages):
		...
		print(next_url)
		tmp=open('lastPage.html','w')#to store just in case the script goes wrong, so the last page can be seen to see what's wrong
		tmp.write(str(page))
		tmp.close()
